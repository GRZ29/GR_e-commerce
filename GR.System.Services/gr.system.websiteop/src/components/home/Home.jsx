...
import QuickArticules from '../quickArticules/QuickArticules';
            ...
            <section className="pt-5">
              ...
              <div className="row">
                <div className="col-md-4">
                  <a href='*' className="category-item" onClick={()=>navigate("/Shop")}>
                ...
                <div className="col-md-4">
                  <a href='*' className="category-item mb-4" onClick={()=>navigate("/Shop")}>
