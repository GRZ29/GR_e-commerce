    ...
    <div className="row">
      <div className="col-xl-3 col-lg-4 col-sm-6">
        <div className="product text-center">
          <div className="position-relative mb-3">
            ...
            <a className="d-block" onClick={() => handleIdSelected(4)}>
              <img
                ...
                src={BASE_URL + "resources/BAR-2202.jpeg"}
                alt="..."
              />
            </a>
          ...
          <h6>
            <a className="reset-anchor">name</a>
          </h6>
        ...
        <div className="product text-center">
          <div className="position-relative mb-3">
            ...
            <a className="d-block" onClick={() => handleIdSelected(5)}>
              <img
                className="img-fluid w-100"
                src={BASE_URL + "resources/EST-2207.jpeg"}
                alt="..."
              />
            </a>
            <div className="product-overlay">
        ...
        <div className="product text-center">
          <div className="position-relative mb-3">
            ...
            <a className="d-block" onClick={() => handleIdSelected(8)}>
              <img
                className="img-fluid w-100"
                src={BASE_URL + "resources/ET-2203.jpeg"}
                alt="..."
              />
            </a>
            <div className="product-overlay">
        ...
        <div className="product text-center">
          <div className="position-relative mb-3">
            ...
            <a className="d-block" onClick={() => handleIdSelected(9)}>
              <img
                className="img-fluid w-100"
                src={BASE_URL + "resources/VEL-2203.jpeg"}
                alt="..."
              />
            </a>
            <div className="product-overlay">
